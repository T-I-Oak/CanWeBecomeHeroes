...
import { getTagFramePaths, getTagPaths, getTagWeight } from './TagCatalog.js';
...
export default class HeroFactory {
  ...
  create({ profession, x, y, maximums, bounds = null, stamina = 0 }) {
    ...
    const chip = new Chip({ id: 0, type: 'hero', x, y, weight: getTagWeight(tags), centerPath: `/assets/heroes/${definition.asset}.png`, tagPaths: getTagPaths(tags), tagFramePaths: getTagFramePaths(tags), bounds });
