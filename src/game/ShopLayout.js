...
export const SHOP_HERO_SLOT_LEFT = 38;
export const SHOP_HERO_SLOT_TOP = 96;
...
export function getShopLayout(area) {
  ...
  const heroSlotX = area.x + SHOP_HERO_SLOT_LEFT;
  const heroSlotY = area.y + SHOP_HERO_SLOT_TOP;
  const horizontalShift = heroSlotX - (area.x + SHOP_HERO_SLOT_LEFT);
  const saleBoardGroupX = area.x + SHOP_SALE_BOARD_LEFT + horizontalShift;
